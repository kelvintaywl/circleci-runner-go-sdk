...
const (
	...
	DefaultHost string = "runner.circleci.com"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Circleci {
	...
	cli.ResourceClass = resource_class.New(transport, formats)
...
type Circleci struct {
	ResourceClass resource_class.ClientService
...
func (c *Circleci) SetTransport(transport runtime.ClientTransport) {
	...
	c.ResourceClass.SetTransport(transport)
