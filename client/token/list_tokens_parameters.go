...
func (o *ListTokensParams) WithResourceClass(resourceClass string) *ListTokensParams {
	o.SetResourceClass(resourceClass)
	return o
}
...
func (o *ListTokensParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// query param resource-class
	qrResourceClass := o.ResourceClass
	qResourceClass := qrResourceClass
	if qResourceClass != "" {

		if err := r.SetQueryParam("resource-class", qResourceClass); err != nil {
			return err
		}
	}
