...
func (m TokenInfo) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.TokenPayload)
	if err != nil {
		return nil, err
	}
...
func (m *TokenInfo) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with TokenPayload
	if err := m.TokenPayload.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *TokenInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with TokenPayload
	if err := m.TokenPayload.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
